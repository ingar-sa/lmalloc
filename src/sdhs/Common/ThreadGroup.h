 ...
 */
tg_manager *TgCreateManager(tg_group **Groups, u64 GroupCount, SdhsArena *A);
 ...
 */
tg_group *TgCreateGroup(u64 GroupId, u64 ThreadCount, void *SharedData,
			tg_init Init, tg_task *Tasks, tg_cleanup Cleanup,
			SdhsArena *A);
/**
