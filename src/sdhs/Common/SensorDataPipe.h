 ...
 */
sensor_data_pipe *SdpCreate(u64 BufCount, u64 BufSize, SdhsArena *Arena);
 ...
 */
SdhsArena *SdPipeGetWriteBuffer(sensor_data_pipe *Pipe);
 ...
 */
SdhsArena *SdPipeGetReadBuffer(sensor_data_pipe *Pipe);
