...
#define SDB_TIME_TO_S(ns) ((u64)((double)ns / (1e9 * SDB_TIME_BASE_NS_)))

#define SDB_TIME_MS(ms)    ((sdb_timediff)(ms * 1e6 * SDB_TIME_BASE_NS_))
#define SDB_TIME_TO_MS(ns) ((u64)((double)ns / (1e6 * SDB_TIME_BASE_NS_)))

#define SDB_TIME_US(us)    ((sdb_timediff)(us * 1e3 * SDB_TIME_BASE_NS_))
#define SDB_TIME_TO_US(ns) ((uint64_t)((double)ns / (1e3 * SDB_TIME_BASE_NS_)))

#define SDB_TIME_NS(ns)    ((sdb_timediff)(ns * 1 * SDB_TIME_BASE_NS_))
#define SDB_TIME_TO_NS(ns) ((u64)((double)ns / (1 * SDB_TIME_BASE_NS_)))
